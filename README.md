...
- **최적성**: CBS는 각 에이전트의 경로가 최단이면서, 전체적으로도 가능한 한 효율적인 경로 집합을 산출합니다.
- **확장성**: 에이전트 수가 늘어나도, 각 에이전트의 독립 탐색과 충돌 분기 방식 덕분에 복잡도 증가를 억제할 수 있습니다.
- **적용 분야**: 물류창고, 공장, 자동화창고 등 멀티로봇 경로 최적화에 널리 사용됩니다.
...
- [gloriyo/MAPF-ICBS: 개선된 CBS 오픈소스 (GitHub)](https://github.com/gloriyo/MAPF-ICBS)
